            ...
            <div class="col-lg-6 col-md-8">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent pb-5">
                        <div class="text-muted text-center mt-2 mb-4"><small>Regístrate en</small></div>
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        @else
                            <div class="text-center text-muted mb-4">
                                <small>O regístrese con credenciales</small>
                            </div>
                        @endif
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" placeholder="Confirma tu contraseña" type="password" name="password_confirmation" required autocomplete="new-password">
                                </div>
                            </div>
                            <div class="row my-4">
                                <div class="col-12">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary mt-4">Crear tu cuenta</button>
                            </div>
                        </form>
                    </div>
                </div>
