            ...
            <form action="{{ route('course.store') }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="teacher_responsible" class="form-control" value="{{ old('teacher_responsible') }}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input class="form-control" type="date" id="date_completion" name="date_completion" value="{{ old('date_completion') }}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-sm-6">
                ...
                <button type="submit" class="btn btn-sm btn-primary">Crear curso</button>
            </form>
        </div>
    </div>
@endsection
